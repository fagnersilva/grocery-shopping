...
class ClassificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create classification" do
    assert_difference('Classification.count') do
      post classifications_url, params: { classification: { classification: @classification.classification } }
    end
  ...
  test "should update classification" do
    patch classification_url(@classification), params: { classification: { classification: @classification.classification } }
